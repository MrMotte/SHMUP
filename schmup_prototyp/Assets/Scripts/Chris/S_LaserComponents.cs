...
public class LaserComponents : MonoBehaviour {
	...
	void Update()
	{
		...
		if (start == null)
		{
			start = Instantiate(laserFront) as GameObject;
		...
		if (hit.collider != null)
		{
			...
			if (end == null)
			{
				end = Instantiate(laserBack) as GameObject;
